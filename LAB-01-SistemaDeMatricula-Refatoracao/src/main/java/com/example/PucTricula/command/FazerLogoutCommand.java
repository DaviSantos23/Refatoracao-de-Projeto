...
public class FazerLogoutCommand implements Command{
    private Administrador administrador;
    private List<Usuario> usuarios;
    private List<Disciplina> disciplinas;
    private Scanner scanner;

    public FazerLogoutCommand(Administrador administrador, List<Usuario> usuarios, List<Disciplina> disciplinas, Scanner scanner) {
    ...
    @Override
    public void execute() {
        administrador.fazerLogout(usuarios, scanner);
    }
