...
public class MatricularAlunoCommand implements Command{
    private Usuario usuario;
    private List<Usuario> usuarios;
    private List<Disciplina> disciplinas;
    private Scanner scanner;

    public MatricularAlunoCommand(Usuario usuario, List<Usuario> usuarios, List<Disciplina> disciplinas, Scanner scanner) {
    ...
    @Override
    public void execute() {
        usuario.atribuirAluno(usuarios, disciplinas, scanner);
    }
}
